...
当前 `MainWindow` 使用十三个标签页分别创建扫雷、蜘蛛纸牌、黑白棋、五子棋、围棋、中国象棋、2048、数独、推箱子、俄罗斯方块、空当接龙、消消乐和中国跳棋 Document，并承载各自的
SDK 边界包装 View。十三个包装 View 都通过单向绑定把 Document 拥有的 ViewModel 交给真正的游戏 View。该结构用于快速
