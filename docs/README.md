...
本解决方案用于开发 `myavalonia.plugin.classic.game` Managed Plugin，当前由独立的扫雷、蜘蛛纸牌、黑白棋与五子棋功能域
...
5. [项目、Host 与 Standalone 窗口职责](project-and-window-responsibilities.md)
6. [临时部署、正式发布与验收](deployment-and-release.md)
7. [Workflow Action Provider 与 Consumer 接入](workflow-actions.md)
