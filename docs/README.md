...
本解决方案用于开发 `myavalonia.plugin.classic.game` Managed Plugin，当前由独立的扫雷、蜘蛛纸牌、黑白棋、五子棋、围棋、中国象棋、2048、数独、推箱子、俄罗斯方块、空当接龙与消消乐功能域
...
13. [项目、Host 与 Standalone 窗口职责](project-and-window-responsibilities.md)
14. [临时部署、正式发布与验收](deployment-and-release.md)
15. [Workflow Action Provider 与 Consumer 接入](workflow-actions.md)
